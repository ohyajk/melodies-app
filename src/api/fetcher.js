...
export const fetchQuery = createAsyncThunk('extra/fetchQuery', async (query) => {
    const response = await fetch(`https://saavn.dev/api/search/all?query=${query}`);
...
export const fetchQuerySong = createAsyncThunk('extra/fetchQuerySong', async (songLink) => {
    const response = await fetch(`https://saavn.dev/api/songs?link=${songLink}`);
    const data = await response.json();
    return data;
});
...
export const fetchQueryAlbum = createAsyncThunk('extra/fetchQueryAlbum', async (albumLink) => {
    const response = await fetch(`https://saavn.dev/api/albums?link=${albumLink}`);
    const data = await response.json();
    return data;
});
...
export const fetchSongsPage = createAsyncThunk('extra/fetchSongsPage', async () => {
    const response = await fetch('https://saavn.dev/api/playlists?id=1070105513');
    const data = await response.json();
    return data;
});
...
export const fetchHomePage = createAsyncThunk('extra/fetchHomePage', async () => {
    const response = await fetch('https://saavn.dev/api/playlists?id=1053900960');
    const data = await response.json();
    return data;
});
...
export const fetchModules = createAsyncThunk('extra/fetchModules', async () => {
    const response = await fetch('https://saavn.dev/api/modules?language=punjabi');
    const data = await response.json();
    return data;
});
